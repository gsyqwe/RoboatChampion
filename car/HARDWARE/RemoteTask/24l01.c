...
const u8 TX_ADDRESS[TX_ADR_WIDTH]={0x34,0x43,0x10,0x10,0x71}; //发送地址
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0x34,0x43,0x10,0x10,0x71}; //发送地址	
...
{  
  ...
  GPIO_SetBits(GPIOB,GPIO_Pin_0);//PB14输出1,防止SPI FLASH干扰NRF的通信 
